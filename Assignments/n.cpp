...
int main () {
    ...
    string data;
    string name = "h.doc";// --change this!! the main function should take in the name argument
    int loadsAndSave = 0;
...
//////////////////
        ...
        if ( instructionLine1 == 1 or instructionLine2 ==1 or instructionLine3 ==1) {
            ...
            opcode[numberOfALU+compareAndJump+loadsAndSave-1] = data.substr(pointer,space-pointer);
            numberOfCodeLines++;
            
            cout <<"space: " << space << endl; //++++++++ delete this plz
        }
